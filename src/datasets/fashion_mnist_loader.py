...
# Fashion MNIST
def get_fashion_mnist_loader(data_dir: str, batch_size: int = 64, val_split_factor: float = 0.1):
    '''
...
if __name__ == '__main__':
    train_loader, val_loader, test_loader = get_fashion_mnist_loader("./data")
